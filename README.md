...
You will want to use class before the name of the component and you will need to extend it to the React.Component. You will also need a constructor and super since you are using extend. In this class component, you will use this.state to set your state and you will also use render() before your return to render your project to the screen
